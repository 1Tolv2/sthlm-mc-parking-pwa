...
export default async function handler(
  ...
  const url = `${process.env.NEXT_APP_TRAFIKVERKET_API_URL}/within?lat=${testCoordinates.latitude}&lng=${testCoordinates.longitude}&outputFormat=json&apiKey=${process.env.NEXT_APP_TRAFIKVERKET_API_KEY}`;
